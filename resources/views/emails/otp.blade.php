                                                ...
                                                <table role="presentation" width="100%" cellpadding="0" cellspacing="0"
                                                    ...
                                                    <tr>
                                                        <td style="padding-right: 0px;padding-left: 0px;"
                                                            ...
                                                            <img align="center" border="0" src="{{URL::asset('/images/otp.png')}}"
                                        ...
                                        <tr>
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:30px 10px 10px;font-family:arial,helvetica,sans-serif;"
                                                ...
                                                <h1 style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-family: 'Montserrat',sans-serif; font-size: 22px; font-weight: 700;">
                                                    <span><span>Ձեր 6-նիշանոց կոդը</span></span></h1>
                                                ...
                                                <div align="center">
                                                    ...
                                                    <div  class="v-button"
                                                       style="box-sizing: border-box; display: inline-block; text-decoration: none; text-size-adjust: none; text-align: center; color: rgb(0, 0, 0); background: rgb(255, 255, 255); border-radius: 0px; width: 38%; max-width: 100%; word-break: break-word; overflow-wrap: break-word; border-color: rgb(0, 0, 0); border-style: solid; border-width: 2px; font-size: 18px; line-height: inherit;"><span
                                                            style="display:block;padding:10px 20px;line-height:120%;">{{$otp}}</span>
                                                    </div>
                                            ...
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:30px 10px 10px;font-family:arial,helvetica,sans-serif;"
                                                ...
                                                <div
                                                    ...
                                                    <p style="line-height: 140%; margin: 0px;">
                                                        Մուտքագրեք 6-նիշանոց կոդը՝ ինքնությունը հաստատելու համար։
                                                    </p>
                                                    <p style="line-height: 140%; margin: 0px;">
                                                        Այս կոդը վավեր է 10 րոպե։
                                                    </p>
                                                    <p style="line-height: 140%; margin: 0px;">Եթե Դուք չեք խնդրել այս կոդը, պարզապես անտեսեք այս նամակը։
                                                    </p>
                                                </div>
