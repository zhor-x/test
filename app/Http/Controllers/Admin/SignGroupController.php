...
use App\Services\Admin\RoadSignGroupService;
use Illuminate\Http\JsonResponse;

class SignGroupController extends Controller
{
    public function __construct(private readonly RoadSignGroupService $groupService)
    {
    }
    ...
    public function update(GroupUpdateRequest $request, int $id): GroupResource
    {
        $payload = $request->validated();
